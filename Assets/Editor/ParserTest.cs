...
public class ParserTest
{
	...
	{
		IParser parser = new ZbarParser();
		List<ParserResult> result = parser.Decode(new Color32[0], 0, 0);
	...
	public void TestEmpty()
	{
		...
		List<ParserResult> result = parser.Decode(image.GetPixels32(), image.width, image.height);
		Assert.IsNull(result);
	}
